...
#include "secp256k1.h"
#include "a_gatekeeper_util_Secp256k1.h"
...
JNIEXPORT jint JNICALL Java_a_gatekeeper_util_Secp256k1_resetContext( JNIEnv * env, jobject obj )
{
  if ( NULL == pCONTEXT )
...
JNIEXPORT jboolean JNICALL Java_a_gatekeeper_util_Secp256k1_privateKeyIsValid
...
JNIEXPORT jbyteArray JNICALL Java_a_gatekeeper_util_Secp256k1_publicKeyCreate
  ( JNIEnv * env, jobject obj, jbyteArray in_seckey )
{
  jbyte* jkey = (*env)->GetByteArrayElements( env, in_seckey, NULL );
  jsize len = (*env)->GetArrayLength( env, in_seckey );
  ...
  {
    fprintf( stderr, "publicKeyCreate: secp256k1_ec_pubkey_create failed" );
    return NULL;
  }
  ...
  size_t outLen = sizeof( serialPubKey );
...
JNIEXPORT jbyteArray JNICALL Java_a_gatekeeper_util_Secp256k1_privateKeyAdd
...
JNIEXPORT jbyteArray JNICALL Java_a_gatekeeper_util_Secp256k1_privateKeyMult
  ( JNIEnv * env, jobject obj, jbyteArray in_seckey, jbyteArray in_tweak )
{
  // java to C - seckey
...
JNIEXPORT jbyteArray JNICALL Java_a_gatekeeper_util_Secp256k1_publicKeyAdd
...
JNIEXPORT jbyteArray JNICALL Java_a_gatekeeper_util_Secp256k1_publicKeyMult
  ( JNIEnv * env, jobject obj, jbyteArray in_pubkey, jbyteArray in_tweak )
{
  // java to C
  jbyte* jkey = (*env)->GetByteArrayElements( env, in_pubkey, NULL );
...
JNIEXPORT jbyteArray JNICALL Java_a_gatekeeper_util_Secp256k1_signECDSA
...
JNIEXPORT jboolean JNICALL Java_a_gatekeeper_util_Secp256k1_verifyECDSA
