  ...
  public static void main( String[] args ) throws Exception
  {
    ...
    for ( int ii = 0; ii < srcs.length; ii++ )
    {
      ...
      System.out.println( "Source:" +
                          HexString.encode(srcs[ii].getBytes()) );

      System.out.println( "Hashed:" + HexString.encode(hashed) );
      System.out.println( "Expect:" + HexString.encode(exp) );
    }
    ...
    if ( Arrays.equals(singres, singlesha) )
      System.out.println( "Good single SHA" );
    else
      System.out.println( "FAIL single SHA" );

    byte[] doubres = doubleHash( msg.getBytes() );

    if ( Arrays.equals(doubres, doublesha) )
      System.out.println( "Good double SHA" );
    else
      System.out.println( "FAIL double SHA" );
  }
}
